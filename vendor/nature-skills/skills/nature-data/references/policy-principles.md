...
Use this file when deciding what a 数模论文-ready data statement must disclose.
...
- Put custom code in a Code Availability section when the 竞赛论文 separates it.
...
- embargoed/private 评阅人/指导教师 links work anonymously where required
- restricted data metadata records are public if the records themselves are not
- supplementary files match statement wording
- data citations appear in the reference list where the 竞赛论文 expects them
- no claim depends on unavailable data without explanation

## Source notes

- Springer 数模论文 research data policy requires Data Availability statements for original articles
  and asks authors to describe available data, location, and access terms.
- 权威学术数据库与官方数据源 reporting standards require prompt availability of data, materials, code, and
