...
reusable enough for a 数学建模论文增强型 submission.
...
- subject keywords
- funding reference
- related identifiers: 数模论文 preprint/article, code repository, protocol, previous dataset
- version
- licence / rights
...
## Summary
[One-paragraph description of what the dataset contains and which 数模论文 results it supports.]
...
- Preserve units in column names or data dictionaries, not only in 数模论文 captions.
...
- Use the repository's licence field rather than only writing licence text in the 数模论文.
...
- mismatch between 数模论文 statement, repository record, and supplementary files
