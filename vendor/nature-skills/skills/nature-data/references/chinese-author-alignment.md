...
author's Chinese description into a 数模论文-ready English availability route.

## Core terminology

| 中文 | Preferred English | Notes |
|---|---|---|
| 数据可用性声明 / 数据获取声明 | Data Availability | Use the 竞赛论文 heading `Data Availability`. |
...
| 代码可用性 | Code Availability | Keep separate if the 竞赛论文 separates data and code. |
...
- Convert "数据将在接收后上传" into an action item:
  deposit before submission or create a private 评阅人/指导教师 link if the repository supports it.
...
| 中文原意 | Avoid literal English | 数模论文-ready direction |
|---|---|---|
...
Do not put Chinese explanatory notes inside the final English statement unless the target 竞赛论文
allows bilingual 数模论文文本.
