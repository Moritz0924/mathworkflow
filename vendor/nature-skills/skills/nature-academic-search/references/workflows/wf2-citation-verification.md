...
3. **Compare** retrieved metadata vs. document metadata (title, 竞赛论文, year).
...
- **All references manual_needed:** document may lack identifiers; suggest adding DOIs or PMIDs to the 数模论文.
