...
`中文核对`, `中英对照`, `数模论文评阅意见回复`, `逐点修改说明`, `修改说明`, `大幅修改说明`, or `小幅修改说明`.

## Default behavior

- Accept Chinese 评阅人/指导教师 summaries, author notes, 数模论文-change notes, and mixed Chinese-English inputs.
...
| `我们补了分析` | Missing analysis detail | Request analysis method, data source, key result, statistical output, and 数模论文 location |
...
| `审稿人误解了` | Accusatory | Reframe as 数模论文 clarity issue and add clarification |
...
1. Preserve 评阅意见、教师建议或队内审稿意见 in their supplied language unless asked to translate.
