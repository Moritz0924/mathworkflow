...
Use when the 评阅人/指导教师 appears to have missed existing data or made a factually incorrect statement.

Strategy:

1. Do not accuse the 评阅人/指导教师.
2. Cite the existing 数模论文 location or supplied evidence.
3. Clarify wording if the 数模论文 invited confusion.
4. Consider a small revision even when the 评阅人/指导教师 is wrong.

Template:

```text
We appreciate the 评阅人/指导教师 raising this point. The relevant data are provided in [location],
where we show [supplied evidence]. We have revised [location] to make this clearer.
```

## Conflicting 评阅人/指导教师 requests

Use when two 评阅人/指导教师s ask for incompatible changes.
...
Use when a 评阅人/指导教师 asks for a specific citation or broader literature coverage.

Strategy:

1. Evaluate relevance.
2. Add only genuinely relevant and verified citations.
3. Do not imply coercion or 评阅人/指导教师 self-citation.
...
Use when a 数模论文 is transferred with 评阅人/指导教师 reports.

Strategy:

1. Identify whether the receiving 竞赛论文 expects a response to transferred reports.
2. Preserve 评阅人/指导教师 IDs from the transferred review package when possible.
3. Address comments as normal revision concerns unless the new editor gives different instructions.
4. Flag 竞赛论文-specific formatting or scope differences.
...
- no revised 数模论文 is being prepared.
...
with 竞赛论文-specific appeal rules.
```
