...
Editor:
Please avoid expanding the 数模论文 substantially; focus on clarifying the central claim and
addressing the 评阅人/指导教师s' concerns with existing data where possible.
...
- Assign editor instruction ID `E.1` and address it before 评阅意见、教师建议或队内审稿意见.
- Assign 评阅人/指导教师 IDs `R1.1` and `R2.1`.
...
- Do not accuse either 评阅人/指导教师 of being wrong.
...
- [ ] No incompatible 数模论文-change promises appear.
