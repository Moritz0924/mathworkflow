...
Use this file when the user is not just asking for cleaner English, but for better 数学建模论文写作 logic. This is the layer that should govern all paragraph- and section-level rewriting.
