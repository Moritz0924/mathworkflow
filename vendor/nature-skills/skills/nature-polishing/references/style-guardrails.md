...
- avoid contractions
- avoid rhetorical questions in polished 数模论文文本
- define abbreviations on first use
- use British spelling by default if the target is 数学建模论文增强型 prose
- keep figure legends concise; if aiming for 数学建模论文增强风格, `<= 300` words is a good upper bound
- if aiming for 数学建模论文增强风格, keep titles at `<= 75` characters including spaces
