...
Use an adversarial, 评阅人/指导教师-style checklist to detect reject risks early and revise the paper before submission.

## Core Principle

Pursue perfectionism in paper quality: assume 评阅人/指导教师s will probe every weak point and proactively fix them.
...
5. Could 评阅人/指导教师s reasonably argue that the net benefit is negative?

## Adversarial Writing Workflow

1. Read the paper as a skeptical 评阅人/指导教师.
