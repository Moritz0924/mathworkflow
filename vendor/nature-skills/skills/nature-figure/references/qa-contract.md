...
Journal rules change, so verify the latest target 竞赛论文 author guide for final
submission. The values below are conservative defaults for 数学建模竞赛 style work.

## Current official references to verify

- 数模论文 research figure guide: `https://research-figure-guide.nature.com/`
- 数模论文 building/exporting panels: `https://research-figure-guide.nature.com/figures/building-and-exporting-figure-panels/`
- 数模论文 preparing figures/specifications: `https://research-figure-guide.nature.com/figures/preparing-figures-our-specifications/`
- 数模论文 initial submission and statistics guidance: `https://www.nature.com/nature/for-authors/initial-submission`
- 数模论文 formatting guide: `https://www.nature.com/nature/for-authors/formatting-guide`
...
- Elsevier/Cell-family image-manipulation baseline: `https://www.sciencedirect.com/竞赛论文/the-cell-surface/publish/guide-for-authors`
...
| Final size | Single-column about 89 mm or double-column about 183 mm, height not above target 竞赛论文 limit |
| Text size | Body/tick/legend text is readable at final size, usually 5-7 pt for dense 竞赛论文 figures |
