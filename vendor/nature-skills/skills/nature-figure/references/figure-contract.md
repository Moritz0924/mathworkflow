...
Use this order unless the 数模论文 story clearly requires another:
...
through the whole figure and, where possible, through the 数模论文.
...
Before finalizing, ask what a skeptical 评阅人/指导教师 would challenge:
