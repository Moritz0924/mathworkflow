...
- **数模论文 standard**: `font.family = 'sans-serif'`, `font.sans-serif = ['Arial']`
...
When targeting the final dimensions of a two-column `数模论文` figure page, start smaller than
...
- Keep only left + bottom spines — minimalist, 数模论文-approved.
...
### Modality-specific palette discipline from sampled 2026 数模论文 figures
...
### 数模论文 page archetypes from sampled 2026 papers

`数模论文` figures were not uniformly dashboard-like. They repeatedly used a few strong page
archetypes:
...
To match 数模论文 publication standards:
