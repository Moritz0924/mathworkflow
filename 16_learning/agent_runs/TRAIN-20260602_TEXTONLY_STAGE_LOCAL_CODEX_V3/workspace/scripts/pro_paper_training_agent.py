...
def write_figures(workspace: Path) -> None:
    ...
    write_csv(
        workspace / "08_figures" / "figure_registry.csv",
        [
            {"figure_id": "FIG_COLOR_CHANNEL", "path": "08_figures/output/color_channel_scatter.png", "used_in_paper": "yes", "quality_score": "4.8", "latex_label": "fig:color_channel_concentration"},
            {"figure_id": "FIG_MODEL_ERROR", "path": "08_figures/output/model_error_compare.png", "used_in_paper": "yes", "quality_score": "4.8", "latex_label": "fig:model_error_compare"},
            {"figure_id": "FIG_PRED_INTERVAL", "path": "08_figures/output/prediction_interval.png", "used_in_paper": "yes", "quality_score": "4.8", "latex_label": "fig:prediction_interval"},
            {"figure_id": "FIG_RESIDUAL_SENS", "path": "08_figures/output/residual_sensitivity.png", "used_in_paper": "yes", "quality_score": "4.8", "latex_label": "fig:residual_sensitivity"},
        ],
        ["figure_id", "path", "used_in_paper", "quality_score", "latex_label"],
    )
...
def write_paper_outputs(workspace: Path, problem_text: str, iteration: int) -> None:
    ...
    sections = {
        ...
        "01_background.tex": "\\section{问题背景与重述}\n本文根据标准样本颜色通道建立浓度预测模型，并对待测样本给出预测区间。\n",
