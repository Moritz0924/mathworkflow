...
required_bindings: claim_id, evidence_id_or_result_id, figure_id_or_formula_id_when_used
promotion_targets: 09_paper/draft_v1.md, 09_paper/anchor_consistency_check.md
validation_expectations: claim_bound, no_new_unverified_claim, no_full_paper_before_contracts
```
