...
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-004: Create the figure files referenced by figure_contract.csv or update the contract to existing files. | acceptance: All registered figure outputs exist in the sandbox workspace. | notes: validation_item=training_figure_contract_file_missing
...
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-006: Create the figure files referenced by figure_contract.csv or update the contract to existing files. | acceptance: All registered figure outputs exist in the sandbox workspace. | notes: validation_item=training_figure_contract_file_missing
...
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-008: Create the figure files referenced by figure_contract.csv or update the contract to existing files. | acceptance: All registered figure outputs exist in the sandbox workspace. | notes: validation_item=training_figure_contract_file_missing
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-009: Add result_id or evidence_source for every figure_contract row and keep the cited figure file path registered. | acceptance: Every figure_contract row has result_id or evidence_source and an existing output path. | notes: validation_item=training_figure_contract_missing_evidence_source
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-010: Create the figure files referenced by figure_contract.csv or update the contract to existing files. | acceptance: All registered figure outputs exist in the sandbox workspace. | notes: validation_item=training_figure_contract_file_missing
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-011: Add result_id or evidence_source for every figure_contract row and keep the cited figure file path registered. | acceptance: Every figure_contract row has result_id or evidence_source and an existing output path. | notes: validation_item=training_figure_contract_missing_evidence_source
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-012: Create the figure files referenced by figure_contract.csv or update the contract to existing files. | acceptance: All registered figure outputs exist in the sandbox workspace. | notes: validation_item=training_figure_contract_file_missing
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_USERAPPROVED_CODEX-VAL-013: Add result_id or evidence_source for every figure_contract row and keep the cited figure file path registered. | acceptance: Every figure_contract row has result_id or evidence_source and an existing output path. | notes: validation_item=training_figure_contract_missing_evidence_source
