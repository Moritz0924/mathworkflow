...
- 08_figures/figure_status.csv (769 bytes)
...
- 09_paper/consistency_risk_report.md (3006 bytes)
...
- 09_paper/full_draft.md (12185 bytes)
- 09_paper/human_rewrite_log.md (139 bytes)
- 09_paper/missing_evidence_report.md (1310 bytes)
...
- 11_review/auto_review_stage_summary.md (377 bytes)
- 11_review/code_reviewer_comments.md (245 bytes)
...
- 11_review/figure_reviewer_comments.md (282 bytes)
- 11_review/figures_stage_summary.md (5036 bytes)
...
- 11_review/judge_reviewer_comments.md (344 bytes)
- 11_review/latex_template_stage_summary.md (331 bytes)
- 11_review/model_reviewer_comments.md (291 bytes)
- 11_review/paper_full_stage_summary.md (1423 bytes)
- 11_review/paper_reviewer_comments.md (318 bytes)
...
- 11_review/problem_reviewer_comments.md (192 bytes)
- 11_review/review_scorecard.csv (905 bytes)
- 11_review/revision_stage_summary.md (730 bytes)
- 11_review/revision_tasks.csv (3033 bytes)
- 11_review/simulated_human_gate_log.csv (1874 bytes)
- 11_review/skill_router_report.json (5728 bytes)
- 11_review/skill_router_report.md (356 bytes)
- 11_review/task_closure_log.md (1422 bytes)
...
F008,Q3,预测区间可视化,07_results/q3_predictions.csv,R15,单图,errorbar,matplotlib,08_figures/scripts/generate_figu
...
为评估泛化能力，对线性模型执行留一交叉验证（LOOCV），得到 CV RMSE = 0.0748 mg/L，与训练误差（0.0674 mg/L）相
[workspace context snapshot truncated to 52000 chars]
