...
- 11_review/simulated_human_gate_log.csv (2823 bytes)
...
```text
gate_id,stage,question,simulated_answer,formal_effect,time_utc,notes
...
2025-06-04T00:00:00,eda,soft,simulated,EDA stage completed. Data quality risks documented. Human should decide on noise injection and approve transition to model_route.,pending,none
task_analysis,soft,passed,2026-06-04T00:00:00,Automated sandbox gate pass after task decomposition; formal human gate simulated.,none
G04,prior_retrieval,soft,simulated_pass_with_placeholder,2025-01-17T09:00:00,none,"Missing config/prior_db_policy.yaml and 01_task_analysis/problem_model_profile.csv; generated placeholder cards only. Formal human gate not executed."
model_route_gate,2025-04-08T12:00:00Z,model_route,simulated,Approved main/fallback models for Q1-Q3 as documented in 05_model/model_route.md. Risk R01-R05 accepted with mitigations. No formal human interaction; sandbox simulation.,none,open,
...
initial_07_results_freeze,results_freeze,results_freeze_gate,2026-06-04T12:00:00Z,pass,sandbox_simulated,Results freeze for Q1 OLS completed; other result files pending verification
2026-06-04T00:00:00Z,figures,simulated,HumanGate: which figures to promote into paper?,decision: all six figures (F001-F006) promoted; Q2/Q3 figures deferred until results frozen,formal_effect=none,system,open
paper_draft,2026-06-04T12:30:00Z,soft,question:是否有重要论断缺少证据，因此不应写入正文或应返回上游补证？,agent_response:C03缺乏显著性检验；C05诊断统计效力不足；未报告VIF；B通道方向解释缺少文献。建议补充相关证据但现有数据足以支撑核心方向论断。草案可提交，但需注明风险。,formal_effect:none,simulated_human_gate_log
paper_full,draft_review_gate,OPEN,2026-06-04T12:30:00Z,none,待人类确认全文草稿及未解决缺口
auto_review,initial_auto_review,review_completed_with_open_tasks,"Generated review comments scorecard and revision tasks; multiple fail/major items require resolution",human may override or waive some tasks; core problem gaps remain,none
revision,revision_closure_gate,accepted,simulated_sandbox,2026-06-04T14:00:00Z,"All revision tasks closed. Figure rendering verification deferred to human. No fail/major tasks remain open."
2026-06-04T15:00:00Z,compile,simulated_sandbox_gate,gate_compile,fail,No LaTeX package to approve; blocked by missing template.,formal_effect=none
```
