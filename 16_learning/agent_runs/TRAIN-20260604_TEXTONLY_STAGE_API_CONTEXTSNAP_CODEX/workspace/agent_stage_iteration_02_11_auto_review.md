...
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-002: Resolve or close fail-level review scorecard items after applying the corresponding sandbox fixes. | acceptance: No review_scorecard row has severity/fail_level=fail unless status is closed/resolved/waived. | notes: validation_item=training_review_fail_unclosed
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-003: Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold. | acceptance: Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present. | notes: validation_item=training_review_score_below_threshold
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-004: Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold. | acceptance: Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present. | notes: validation_item=training_review_score_below_threshold
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-005: Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold. | acceptance: Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present. | notes: validation_item=training_review_score_below_threshold
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-006: Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold. | acceptance: Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present. | notes: validation_item=training_review_score_below_threshold
...
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-010: Update figure_contract.csv so every result_id exists in result_contract.csv. | acceptance: Every figure result_id is present in result_contract.csv. | notes: contract_item=figure_unknown_result
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-011: Update figure_contract.csv so every result_id exists in result_contract.csv. | acceptance: Every figure result_id is present in result_contract.csv. | notes: contract_item=figure_unknown_result
- [fail] TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-012: Update figure_contract.csv so every result_id exists in result_contract.csv. | acceptance: Every figure result_id is present in result_contract.csv. | notes: contract_item=figure_unknown_result
...
- 09_paper/paper_full_stage_summary.md (2465 bytes)
...
- 11_review/contract_validation_report.json (4749 bytes)
- 11_review/contract_validation_report.md (2579 bytes)
- 11_review/figure_reviewer_comments.md (1366 bytes)
- 11_review/figures_stage_summary.md (2948 bytes)
...
- 11_review/simulated_human_gate_log.csv (1556 bytes)
...
- 12_submission/final_submit_package.md (2039 bytes)
- 12_submission/final_submit_paper.md (11743 bytes)
- 12_submission/submission_checklist.md (144 bytes)
...
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-001,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\12_submission\final_submit_paper.md,"chars=5722, sections=6","Expand 12_submission/final_submit_paper.md from the latest full_draft with substantive problem analysis, model, results, validation, and conclusion sections.",final_submit_paper.md has at least 2500 characters and at least seven sections.,open,,validation_item=training_final_paper_too_thin
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-002,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,"row 2: {'round_id': '1', 'reviewer': 'problem_reviewer', 'dimension': 'Problem Coverage', 'score': '3', 'max_score': '10', 'severity': 'fail', 'issue_count': '4', 'top_risk': 'Q2 and Q3 solution missing', 'required_action': 'Complete Q2 model comparison and Q3 uncertainty quantification', 'status': 'open', 'last_checked': '2026-06-04T12:30:00Z'}",Resolve or close fail-level review scorecard items after applying the corresponding sandbox fixes.,No review_scorecard row has severity/fail_level=fail unless status is closed/resolved/waived.,open,,validation_item=training_review_fail_unclosed
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-003,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,row 2: 3.0/10.0,"Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold.","Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present.",open,,validation_item=training_review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-004,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,row 3: 5.0/10.0,"Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold.","Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present.",open,,validation_item=training_review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-005,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,row 4: 4.0/10.0,"Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold.","Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present.",open,,validation_item=training_review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-006,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,row 5: 7.0/10.0,"Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold.","Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present.",open,,validation_item=training_review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-007,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,row 6: 6.0/10.0,"Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold.","Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present.",open,,validation_item=training_review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-008,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,"row 7: {'round_id': '1', 'reviewer': 'judge_reviewer', 'dimension': 'Overall Judgment', 'score': '3', 'max_score': '10', 'severity': 'fail', 'issue_count': '3', 'top_risk': 'Submission fails core requirements', 'required_action': 'Resolve all fail and major issues before resubmission', 'status': 'open', 'last_checked': '2026-06-04T12:30:00Z'}",Resolve or close fail-level review scorecard items after applying the corresponding sandbox fixes.,No review_scorecard row has severity/fail_level=fail unless status is closed/resolved/waived.,open,,validation_item=training_review_fail_unclosed
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-VAL-009,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX\workspace\11_review\review_scorecard.csv,row 7: 3.0/10.0,"Fix the underlying low-score artifacts first: result sources, figure files/contracts, paper sections, evidence bindings, and revision tasks; then rerun auto_review so scores rise above threshold.","Every review_scorecard row is at least 85% of max_score, with supporting artifact fixes present.",open,,validation_item=training_review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-010,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,14_contracts/figure_contract.csv,F001 references missing result_id=R01;R02;R03;R04,Update figure_contract.csv so every result_id exists in result_contract.csv.,Every figure result_id is present in result_contract.csv.,open,,contract_item=figure_unknown_result
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-011,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,14_contracts/figure_contract.csv,F002 references missing result_id=R05;R06,Update figure_contract.csv so every result_id exists in result_contract.csv.,Every figure result_id is present in result_contract.csv.,open,,contract_item=figure_unknown_result
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-012,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,14_contracts/figure_contract.csv,F003 references missing result_id=R05;R06,Update figure_contract.csv so every result_id exists in result_contract.csv.,Every figure result_id is present in result_contract.csv.,open,,contract_item=figure_unknown_result
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-013,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,14_contracts/figure_contract.csv,F004 references missing result_id=R05;R06,Update figure_contract.csv so every result_id exists in result_contract.csv.,Every figure result_id is present in result_contract.csv.,open,,contract_item=figure_unknown_result
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-014,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,14_contracts/claim_evidence_map.csv,C06 references missing citation_id=moderate,"Bind each active claim to an existing result_id, figure_id, formula_id, citation_id, or evidence_ref.",validate_contracts.py no longer reports unsupported_claim for claim_evidence_map.csv.,open,,contract_item=unsupported_claim
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-015,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,14_contracts/polish_diff_check.csv,"POL-000 protected_atom_delta_count=0, decision=blocked","Resolve contract validation failure polish_changed_protected_atom: POL-000 protected_atom_delta_count=0, decision=blocked",validate_contracts.py no longer reports polish_changed_protected_atom.,open,,contract_item=polish_changed_protected_atom
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-016,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,11_review/review_scorecard.csv,row 2: 30.0 < 85.0,"Improve the underlying result sources, figures, paper, and evidence bindings before rerunning auto_review.",review_scorecard.csv scores are at least 85% of max_score and the artifact fixes are present.,open,,contract_item=review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-017,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,11_review/review_scorecard.csv,row 2 severity=fail status=open,Close or resolve fail-level review rows only after the corresponding sandbox fix is applied.,No fail-level review scorecard row remains open.,open,,contract_item=review_fail_unclosed
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-018,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,11_review/review_scorecard.csv,row 3: 50.0 < 85.0,"Improve the underlying result sources, figures, paper, and evidence bindings before rerunning auto_review.",review_scorecard.csv scores are at least 85% of max_score and the artifact fixes are present.,open,,contract_item=review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-019,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,11_review/review_scorecard.csv,row 4: 40.0 < 85.0,"Improve the underlying result sources, figures, paper, and evidence bindings before rerunning auto_review.",review_scorecard.csv scores are at least 85% of max_score and the artifact fixes are present.,open,,contract_item=review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-020,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,11_review/review_scorecard.csv,row 5: 70.0 < 85.0,"Improve the underlying result sources, figures, paper, and evidence bindings before rerunning auto_review.",review_scorecard.csv scores are at least 85% of max_score and the artifact fixes are present.,open,,contract_item=review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-021,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,11_review/review_scorecard.csv,row 6: 60.0 < 85.0,"Improve the underlying result sources, figures, paper, and evidence bindings before rerunning auto_review.",review_scorecard.csv scores are at least 85% of max_score and the artifact fixes are present.,open,,contract_item=review_score_below_threshold
TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX-CONTRACT-022,TRAIN-20260604_TEXTONLY_STAGE_API_CONTEXTSNAP_CODEX,contract_validation,fail,11_review/review_scorecard.csv,row 7: 30.0 < 85.0,"Improve the underlying result sources, figures, paper, and evidence bindings before rerunning auto_review.",review_scorecard.csv scores are at least 85% of max_score and the artifact fixes are present.,open,,contract_item=review_s
...
- SRCad03b2fb65cc | 预测回归 | 多元回归 | card=CARD60dd60d8f596 | score=0.321235
- SRCfb178d4139ba | 预测回归 | 多元回归 | card=CARD60dd60d8f596 | score=0.321235
- SRC4225edb1178d | 预测回归 | 多元回归 | card=CARD60dd60d8f596 | score=0.321235
...
| chars | 5722 | 30069.67 |
| sections | 17 | 0.00 |
| figure_mentions | 11 | 4.33 |
| table_mentions | 8 | 13.67 |
| formula_mentions | 3 | 1.67 |
| validation_mentions | 35 | 44.67 |
...
为评估线性回归基本假设的满足情况，绘制了残差-拟合值散点图（图F003）和残差正态 Q-Q 图（图F004）
