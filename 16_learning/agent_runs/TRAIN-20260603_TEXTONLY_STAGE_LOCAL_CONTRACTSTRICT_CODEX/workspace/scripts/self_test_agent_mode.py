...
from validate_agent_run import figure_output_paths, paper_figure_references, topic_alignment_issue  # noqa: E402
...
def main() -> None:
    tests = [test_strict_protocol, test_problem_lock_drift, test_final_contract_nonempty_gate, test_topic_alignment_and_figure_refs]
    passed = []
    for test in tests:
        test()
