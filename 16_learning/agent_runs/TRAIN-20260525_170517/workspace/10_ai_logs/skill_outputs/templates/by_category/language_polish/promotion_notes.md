...
required_bindings: artifact_id, section_id_or_claim_id
promotion_targets: 09_paper/draft_v2_polished.md, 14_contracts/polish_diff_check.csv, 09_paper/ai_style_risk_check.md
validation_expectations: protected_atoms_match, no_new_unverified_claim, diff_based_change_only
```
