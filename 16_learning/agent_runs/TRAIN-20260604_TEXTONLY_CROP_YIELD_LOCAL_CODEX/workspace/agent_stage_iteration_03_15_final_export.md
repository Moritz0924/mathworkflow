...
Revision queue: `E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX\reports\agent_revision_queue.csv`

Open fail/major queue items:
- [major] TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX-TASK-001: Add validation, sensitivity, robustness, or error analysis tied to model outputs. | acceptance: Validation section cites frozen result rows or reproducible code outputs. | notes: from TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX-GAP-003
- [fail] TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX-VAL-002: Expand 12_submission/final_submit_paper.md from the latest full_draft with substantive problem analysis, model, results, validation, and conclusion sections. | acceptance: final_submit_paper.md has at least 2500 characters and at least seven sections. | notes: validation_item=training_final_paper_too_thin
...
- 09_paper/full_draft.md (2355 bytes)
...
- 11_review/contract_validation_report.json (151 bytes)
- 11_review/contract_validation_report.md (154 bytes)
...
- 12_submission/final_submit_paper.md (2355 bytes)
...
TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX-TASK-001,TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX,1,major,16_learning/agent_runs/TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX/workspace/09_paper/full_draft.md,our_count=11; benchmark_average=13.40; threshold=13.40,"Add validation, sensitivity, robustness, or error analysis tied to model outputs.",Validation section cites frozen result rows or reproducible code outputs.,open,,from TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX-GAP-003
TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX-VAL-002,TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX,validation,fail,E:\math-module\math-workflow\math-workflow\16_learning\agent_runs\TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX\workspace\12_submission\final_submit_paper.md,"chars=921, h2=6, headings=6","Expand 12_submission/final_submit_paper.md from the latest full_draft with substantive problem analysis, model, results, validation, and conclusion sections.",final_submit_paper.md has at least 2500 characters and at least seven sections.,open,,validation_item=training_final_paper_too_thin
```
...
TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX-GAP-003,validation_completeness,major,SRCad03b2fb65cc;SRCfb178d4139ba;SRC4225edb1178d,our_count=11; benchmark_average=13.40; threshold=13.40,16_learning/agent_runs/TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX/workspace/09_paper/full_draft.md,"Add validation, sensitivity, robustness, or error analysis tied to model outputs.",Validation section cites frozen result rows or reproducible code outputs.,open,
```
...
- draft: 16_learning/agent_runs/TRAIN-20260604_TEXTONLY_CROP_YIELD_LOCAL_CODEX/workspace/09_paper/full_draft.md
- draft_status: existing
- benchmark_source: local prior DB

## Benchmark Sources

- SRCad03b2fb65cc | 预测回归 | 多元回归 | card=CARD60dd60d8f596 | score=0.256121
- SRCfb178d4139ba | 预测回归 | 多元回归 | card=CARD60dd60d8f596 | score=0.256121
- SRC4225edb1178d | 预测回归 | 多元回归 | card=CARD60dd60d8f596 | score=0.256121
...
| formula_mentions | 2 | 1.67 |
| validation_mentions | 11 | 44.67 |
...
R-Q1-001,Q1,M-LIN,dominant_driver_light_irrigation,positive,direction,07_results/metrics_summary.csv,analysis,06_code/run_all.py,local_crop_training,42,A1,F1,C1,ready,2026-06-04T21:15:49,local_training_agent,text-only crop-yield sandbox
R-Q2-001,Q2,M-RIDGE,ridge_cv_rmse,0.29,kg/m2,07_results/metrics_summary.csv,ridge,06_code/run_all.py,local_crop_training,42,A1,F2,C2,ready,2026-06-04T21:15:49,local_training_agent,best local validation metric
R-Q3-001,Q3,M-RIDGE,P01_pred,7.7,kg/m2,07_results/q3_results.csv,P01,06_code/run_all.py,local_crop_training,42,A1,F3,C3,ready,2026-06-04T21:15:49,local_training_agent,
R-Q3-002,Q3,M-RIDGE,P02_pred,8.8,kg/m2,07_results/q3_results.csv,P02,06_code/run_all.py,local_crop_training,42,A1,F3,C3,ready,2026-06-04T21:15:49,local_training_agent,
R-Q3-003,Q3,M-RIDGE,P03_pred,9.2,kg/m2,07_results/q3_results.csv,P03,06_code/run_all.py,local_crop_training,42,A1,F3,C3,ready,2026-06-04T21:15:49,local_training_agent,
```
...
C1,Q1,model,光照、灌溉和施氮对温室番茄单位面积产量具有主要正向作用。,model,result,R-Q1-001,R-Q1-001,F1,EQ1,,strong,12 个训练批次范围内,小样本不能作远距离外推,ready,local_training_agent,2026-06-04T21:15:49
C2,Q2,validation,岭回归在留一交叉验证 RMSE 上优于线性模型和二次响应面模型。,result,result,R-Q2-001,R-Q2-001,F2,EQ2,,strong,留一交叉验证,验证样本较少,ready,local_training_agent,2026-06-04T21:15:49
C3,Q3,results,P01、P02、P03 的单位面积产量预测分别约为 7.7、8.8、9.2 kg/m2。,result,result,R-Q3-001,R-Q3-001,F3,EQ3,,strong,待评估批次变量位于训练范围附近,区间为经验残差区间,ready,local_training_agent,2026-06-04T21:15:49
```
...
three_iteration_training,pass,,iteration=3,local executor iteration marker
```
...
REV-001,training,major,09_paper/full_draft.md,need validation and contract binding,add validation section and contract references,closed,local_training_agent,iteration 3
```
...
model_route,model_route_gate,approve_for_training_sandbox,05_model/model_route.md; 14_contracts/formula_contract.csv,small-sample model choice still requires human review in formal mode,none
results_freeze,results_freeze_gate,approve_for_training_sandbox,14_contracts/result_contract.csv; 07_results/metrics_summary.csv,synthetic sandbox results cannot become formal facts,none
paper_full,draft_review_gate,approve_for_training_sandbox_revision,09_paper/full_draft.md; 11_review/review_scorecard.csv,formal paper still requires human draft review,none
compile,final_submission_gate,approve_training_submission_package,12_submission/final_submit_paper.md; 12_submission/final_submit_package.md,training package is not a formal contest submission,none
```
