...
CONTRACT_STAGE_MAP = {
    ...
    "review_score_below_threshold": ["auto_review", "final_export"],
...
def contract_issue_action(item: str, detail: str) -> Tuple[str, str]:
    actions = {
        ...
        "review_score_below_threshold": (
            "Improve the underlying sandbox artifacts and rerun auto_review so every score is at least 85%.",
            "review_scorecard.csv scores are at least 85% of max_score.",
        ),
