...
required_bindings: final_package_id, section_id_or_figure_id_when_reused
promotion_targets: 12_export/
validation_expectations: human_final_gate_satisfied, no_new_result_claim, must_not_modify_final_paper
```
