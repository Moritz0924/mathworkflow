...
required_bindings: claim_id_or_section_id, citation_id
promotion_targets: 14_contracts/citation_contract.csv, 02_literature/citation_gap_report.md
validation_expectations: metadata_verified, citation_supports_claim_role, metadata_only_not_used_for_results
```
