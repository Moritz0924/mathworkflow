...
required_bindings: prior_card_id, source_id, problem_type
promotion_targets: 13_sample_prior/, 05_model/model_route.md
validation_expectations: copy_risk_check, no_copied_text, experience_card_only
```
