...
## 未关闭的修订任务（必须逐项完成并做出回应）

### REV-PR-001 [FAIL]
- 位置：全文及文末参考文献
- 问题：论文没有文内引文或参考文献且引用合同没有数据行。
- 要求：基于真实且已核验已阅读的来源补齐必要文内引文和参考文献；逐条登记 citation_contract；不得将历史论文作为引用来源或复用历史正文。
- 验收：正文含与合同一致的引文和参考文献；至少一条 citation_contract 数据行的 metadata_verified=true personally_read=true 且 support_grade 不为 metadata_only；重新检查通过。

### REV-PR-002 [MAJOR]
- 位置：第 4.2 节视线距离定义与遮蔽判据
- 问题：正文使用 d_ikjq(t) 但 FML007 和 FML008 已冻结为 delta_ikjq(t)。
- 要求：使符号定义和遮蔽条件与 FML007 和 FML008 完全一致；不得引入新公式口径。
- 验收：复审时论文中的投影参数垂距和判据与 FML007 FML008 逐项一致。
- 关联合同：FML007;FML008

### REV-PR-003 [MAJOR]
- 位置：多弹区间并集定义
- 问题：正文并集缺少 y_ik=1 的使用条件。
- 要求：依 FML010 恢复该条件或写成与其严格等价且已登记的表达；不得依赖未声明的空区间约定。
- 验收：复审时正文并集公式与 FML010 完全一致且符号已定义。
- 关联合同：FML010

### REV-PR-004 [MAJOR]
- 位置：Q5 字典序目标说明
- 问题：正文引入未冻结的近优容差。
- 要求：删除该口径并按 FML013 的严格字典序目标表述；若确需容差则必须退回 model_design 并重新执行人工模型冻结。
- 验收：复审时正文无未登记近优容差且 Q5 目标与 FML013 完全一致。
- 关联合同：FML013

请在回复正文中逐一写出你对上述每项任务的完成情况，不能只复制原论文。
...
stage: paper_review
handoff_id: H-6FFDA02B228F
context_sha256: 99c803b69adc83f45934497a62f0786b92f4615db2058fd3ede2c0e619a8601f
---
...
## `07_results/frozen/freeze_confirmation.md`
...
- human_gate_confirmed_at: `2026-07-22T12:00:58+00:00`
...

{
  ...
  "human_gate_confirmed_at": "2026-07-22T12:00:58+00:00",
  "controller_event": {
    "at": "2026-07-22T12:00:58+00:00",
    "event": "human_gate_confirmed",
    "stage": "result_freeze",
    "gate": "result_freeze_gate"
  },
  "source_ready_package": "07_results/ready_for_freeze",
  "source_ready_manifest_sha256": "7e8d7654f6b2d61c3e50a8c3177f88eeb1cb50a716ba3e434fe49c40dbe78b18",
...
Q1,primary_duration_M1,1.3622014999389869,s,frozen,Q1/M1
Q2,primary_duration_M1,2.2381643772125575,s,frozen,Q2/M1
Q3,primary_duration_M1,2.2381643772125575,s,frozen,Q3/M1
Q4,primary_duration_M1,2.2381643772125575,s,frozen,Q4/M1
Q5,primary_duration_M1,2.2381643772125575,s,frozen,Q5/M1
Q5,primary_duration_M2,1.9820433139801334,s,frozen,Q5/M2
Q5,primary_duration_M3,1.8768008708953303,s,frozen,Q5/M3
Q5,objective_total_duration,6.097008562088021,s,frozen,Q5/M1;M2;M3
Q5,objective_minimum_duration,1.8768008708953303,s,frozen,Q5/M1;M2;M3
...
Q1,FY1,1,M1,1,180.0,120.0,1.5,3.6,5.1,17620.0,0.0,1800.0,17188.0,0.0,1736.496,1.3622014999389869,"[[8.056308984756512, 9.4185104846955]]",frozen


## `07_results/frozen/q2_results.csv`

﻿question_id,uav_id,bomb_id,missile_id,is_used,heading_deg,speed_mps,release_time_s,delay_s,detonation_time_s,release_x_m,release_y_m,release_z_m,detonation_x_m,detonation_y_m,detonation_z_m,effective_duration_s,occlusion_intervals,result_status
Q2,FY1,1,M1,1,179.43654517246082,130.08336768519578,2.838973088474825,4.978182512298204,7.817155600773029,17430.714677459066,3.631721349123526,1800.0,16783.16724483817,9.999999999999895,1678.5667244838169,2.2381643772125575,"[[7.817155600773029, 10.055319977985587]]",frozen


## `07_results/frozen/q3_results.csv`

﻿question_id,uav_id,bomb_id,missile_id,is_used,heading_deg,speed_mps,release_time_s,delay_s,detonation_time_s,release_x_m,release_y_m,release_z_m,detonation_x_m,detonation_y_m,detonation_z_m,effective_duration_s,occlusion_intervals,result_status
Q3,FY1,1,M1,1,179.43654517246082,130.08336768519578,2.838973088474825,4.978182512298204,7.817155600773029,17430.714677459066,3.631721349123526,1800.0,16783.16724483817,9.999999999999895,1678.5667244838169,2.2381643772125575,"[[7.817155600773029, 10.055319977985587]]",frozen
Q3,FY1,2,M1,1,179.43654517246082,130.08336768519578,3.838973088474825,4.978182512298204,8.81715560077303,17300.637599927017,4.910959029771843,1800.0,16653.09016730612,11.279237680648212,1678.5667244838169,0,[],frozen
Q3,FY1,3,M1,1,179.43654517246082,130.08336768519578,4.838973088474825,4.978182512298204,9.81715560077303,17170.56052239497,6.19019671042016,1800.0,16523.013089774075,12.55847536129653,1678.5667244838169,0,[],frozen


## `07_results/frozen/q4_results.csv`

﻿question_id,uav_id,bomb_id,missile_id,is_used,heading_deg,speed_mps,release_time_s,delay_s,detonation_time_s,release_x_m,release_y_m,release_z_m,detonation_x_m,detonation_y_m,detonation_z_m,effective_duration_s,occlusion_intervals,result_status
Q4,FY1,1,M1,1,179.43654517246082,130.08336768519578,2.838973088474825,4.978182512298204,7.817155600773029,17430.714677459066,3.631721349123526,1800.0,16783.16724483817,9.999999999999895,1678.5667244838169,2.2381643772125575,"[[7.817155600773029, 10.055319977985587]]",frozen
Q4,FY2,1,M1,1,180.0,120.0,1.5,3.6,5.1,11820.0,1400.0,1400.0,11388.0,1400.0,1336.496,0,[],frozen
Q4,FY3,1,M1,1,180.0,120.0,1.5,3.6,5.1,5820.0,-3000.0,700.0,5388.0,-3000.0,636.496,0,[],frozen


## `07_results/frozen/q5_results.csv`

﻿question_id,uav_id,bomb_id,missile_id,is_used,heading_deg,speed_mps,release_time_s,delay_s,detonation_time_s,release_x_m,release_y_m,release_z_m,detonation_x_m,detonation_y_m,detonation_z_m,effective_duration_s,occlusion_intervals,result_status
Q5,FY1,1,M1,1,179.43654517246082,130.08336768519578,2.838973088474825,4.978182512298204,7.817155600773029,17430.714677459066,3.631721349123526,1800.0,16783.16724483817,9.999999999999895,1678.5667244838169,2.2381643772125575,"[[7.817155600773029, 10.055319977985587]]",frozen
Q5,FY1,2,,0,,,,,,,,,,,,,[],frozen
Q5,FY1,3,,0,,,,,,,,,,,,,[],frozen
Q5,FY2,1,M2,1,275.5970977478011,100.88690594525764,6.0857908606118745,3.555641037660742,9.641431898272616,12059.882666072617,788.9506205518344,1400.0,12094.869288158236,431.94324067868115,1338.051342375384,1.9820433139801334,"[[9.641431898272616, 11.62347521225275]]",frozen
Q5,FY2,2,,0,,,,,,,,,,,,,[],frozen
Q5,FY2,3,,0,,,,,,,,,,,,,[],frozen
Q5,FY3,1,,0,,,,,,,,,,,,,[],frozen
Q5,FY3,2,,0,,,,,,,,,,,,,[],frozen
...
Q5,FY4,2,,0,,,,,,,,,,,,,[],frozen
Q5,FY4,3,,0,,,,,,,,,,,,,[],frozen
Q5,FY5,1,M3,1,119.30217914169313,121.14131300438812,13.136138284985464,2.1695621915927563,15.30570047657822,12221.178713062363,-612.2804622520769,1300.0,12092.548732051975,-383.08495773506553,1276.935699494375,1.8768008708953303,"[[15.30570047657822, 17.18250134747355]]",frozen
Q5,FY5,2,,0,,,,,,,,,,,,,[],frozen
Q5,FY5,3,,0,,,,,,,,,,,,,[],frozen


## `07_results/frozen/result_source_map.csv`

﻿result_id,question_id,source_file,result_status,producing_run_id,source_candidate_run
ready_q1_plans,Q1,07_results/ready_for_freeze/q1_results.csv,frozen,RF-20260722T114756Z,result_freeze_validation/runs/refined
ready_q2_plans,Q2,07_results/ready_for_freeze/q2_results.csv,frozen,RF-20260722T114756Z,result_freeze_validation/runs/refined
ready_q3_plans,Q3,07_results/ready_for_freeze/q3_results.csv,frozen,RF-20260722T114756Z,result_freeze_validation/runs/refined
ready_q4_plans,Q4,07_results/ready_for_freeze/q4_results.csv,frozen,RF-20260722T114756Z,result_freeze_validation/runs/refined
ready_q5_plans,Q5,07_results/ready_for_freeze/q5_results.csv,frozen,RF-20260722T114756Z,result_freeze_validation/runs/refined
...
## `07_results/frozen/template_mapping_expected.csv`
...
## `07_results/frozen/template_mapping_verification.json`
